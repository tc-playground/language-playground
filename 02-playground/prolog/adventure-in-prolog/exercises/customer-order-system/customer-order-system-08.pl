...
customer("Bob", address("9, Some Road", "Bristol", "BS4 3BQ"), "Good").
customer("Fred", address("3, Some Close", "Oxford", "OX12 4CD"), "Bad").
customer("Charlotte", address("22", "Arcacia Avenue", "London", "LN666 3TW"), "Excellant").
customer("Waltero", address("3, Some Close", "Bristol", "BS5 12NM"), "Good").
